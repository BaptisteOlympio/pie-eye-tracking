...
from . import openfaceservice_pb2 as openfaceservice__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in openfaceservice_pb2_grpc.py depends on'
...
class OpenFaceServiceStub(object):
...
def add_OpenFaceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'OpenFaceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('OpenFaceService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class OpenFaceService(object):
    """Missing associated documentation comment in .proto file."""
